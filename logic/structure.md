...
마지막 갱신 시점: 2026-04-30 (탭 전환 버그 수정 — home.js showTab() 의 sector-tab 숨김 목록에 'tab-market-valuation' 누락으로 시장 밸류 탭 한 번 열고 다른 탭 가면 두 탭 콘텐츠가 겹쳐 보이던 문제 해결. update.py [62])
