...
const I18N = {
  ko: {
    ...
    'tab.signal': '평소 이탈도',                   // 평소 이탈도 탭 (구 신호 탭)
    // ── 평소 이탈도 (Anomaly Detection) ──
    'an.cardLabel': '시장 평소 이탈도',
    'an.chartLabel': '10년 평소 이탈도 추이',
    'an.contribsLabel': '무엇이 평소와 다른가',
    'an.knnLabel': '과거 같은 패턴',
    'an.disclaimer': '과거 데이터 기준의 거리 측정이며, 미래 방향을 예측하지 않습니다. 매수·매도 권유가 아닙니다.',
    'tile.anomaly': '평소 이탈도',
    'tile.anomalySub': '과거 평소와의 거리',
    ...
    // ── KR 거시 12종 + derived 2 ──
    'macro.kr_indpro_yoy': '광공업생산 YoY',
    'macro.kr_yield_spread': '금리차 (10Y-3Y)',
    'macro.kr_credit_spread': '회사채 스프레드 (AA-3Y)',
    'macro.kr_unemp_yoy': '실업률 YoY',
    'macro.kr_unemp_rate': '실업률',
    'macro.kr_permit_yoy': '건축허가 YoY',
    'macro.kr_retail_yoy': '소매판매 YoY',
    'macro.kr_capex_yoy': '설비투자 YoY',
    'macro.kr_income_yoy': '가계소득 YoY',
    'macro.kr_cpi_yoy': 'CPI YoY (소비자물가)',
    'macro.kr_gdp_yoy': '실질 GDP YoY',
    'macro.kr_m2_yoy': 'M2 YoY (광의통화)',
    'macro.kr_indpro_chg3m': '광공업 3개월변화',
    'macro.kr_capex_yoy_chg3m': '설비투자 3개월변화',

    // ── KR 거시 설명 ──
    'macroDesc.kr_indpro_yoy': '광공업생산지수 전년비 변화율 (제조업 생산 모멘텀)',
    'macroDesc.kr_yield_spread': '국고채 10년-3년 스프레드 (역전 시 침체 신호)',
    'macroDesc.kr_credit_spread': '회사채 AA-3Y - 국고채 3Y (신용 리스크)',
    'macroDesc.kr_unemp_yoy': '실업률 전년비 변화율 (양수=고용 악화)',
    'macroDesc.kr_unemp_rate': '실업률 (계절조정, KR 평균 ~3%)',
    'macroDesc.kr_permit_yoy': '건축허가 면적 전년비 변화율 (부동산 선행지표)',
    'macroDesc.kr_retail_yoy': '소매판매액지수 전년비 변화율 (소비 지표)',
    'macroDesc.kr_capex_yoy': '설비투자지수 전년비 변화율 (기업투자)',
    'macroDesc.kr_income_yoy': '가계소득 전년비 변화율 (분기, ffill)',
    'macroDesc.kr_cpi_yoy': '소비자물가지수 전년비 (BOK 타깃 2%)',
    'macroDesc.kr_gdp_yoy': '실질 GDP 전년비 (분기, ffill)',
    'macroDesc.kr_m2_yoy': 'M2 광의통화 전년비 (유동성 지표)',
    'macroDesc.kr_indpro_chg3m': '광공업 YoY 3개월 변화량 (모멘텀)',
    'macroDesc.kr_capex_yoy_chg3m': '설비투자 YoY 3개월 변화량',
    ...
    // ── KR Crash/Surge 24 피처 라벨 ──
    'feat.KOSPI_LOGRET_1D': '코스피 1일 수익률',
    'feat.KOSPI_LOGRET_5D': '코스피 5일 수익률',
    'feat.KOSPI_LOGRET_10D': '코스피 10일 수익률',
    'feat.KOSPI_LOGRET_20D': '코스피 20일 수익률',
    'feat.KOSPI_DRAWDOWN_60D': '코스피 60일 낙폭',
    'feat.KOSPI_MA_GAP_50': '코스피 50일선 괴리',
    'feat.KOSPI_MA_GAP_200': '코스피 200일선 괴리',
    'feat.VKOSPI_LEVEL': 'VKOSPI',
    'feat.VKOSPI_CHANGE_1D': 'VKOSPI 1일변화',
    'feat.VKOSPI_PCTL_252D': 'VKOSPI 백분위',
    'feat.KR_CORP_AA3Y_SPREAD': '회사채 AA-3Y 스프레드',
    'feat.KR_CORP_SPREAD_CHG_5D': '회사채 스프레드 5일변화',
    'feat.KR_CORP_SPREAD_CHG_20D': '회사채 스프레드 20일변화',
    'feat.KR_DGS10_LEVEL': '한국 10년 국고채',
    'feat.KR_T10Y3M_SLOPE': '한국 장단기 차',
    'feat.FOREIGN_NET_BUY_1D': '외국인 1일 순매수',
    'feat.FOREIGN_NET_BUY_5D': '외국인 5일 순매수',
    'feat.USDKRW_RET_5D': '원·달러 5일수익',
    'feat.KOSPI_DOLLAR_VOL_Z_20D': '코스피 거래대금 Z',
  ...
  en: {
    ...
    'tab.signal': 'Deviation',
    // ── Market Deviation (Anomaly Detection) ──
    'an.cardLabel': 'Market Deviation From Normal',
    'an.chartLabel': '10-Year Deviation History',
    'an.contribsLabel': 'What Differs From Normal',
    'an.knnLabel': 'Similar Past Periods',
    'an.disclaimer': 'Distance measurement against historical data only — not a forecast and not a buy/sell recommendation.',
    'tile.anomaly': 'Deviation',
    'tile.anomalySub': 'Distance From Normal',
    'tab.macro': 'Macro',
    ...
    'sector.091160': 'Semiconductor (KODEX)',
    'sector.300610': 'Game Industry',
    'sector.091170': 'Banks',
    'sector.139250': 'Energy/Chemical',
    'sector.266420': 'Healthcare',
    'sector.091180': 'Auto',
    'sector.117680': 'Steel',
    'sector.341850': 'REIT',
    'sector.227560': 'Consumer Staples',

    // ── KR Macro 12 + derived 2 ──
    'macro.kr_indpro_yoy': 'Industrial Production YoY',
    'macro.kr_yield_spread': 'Yield Spread (10Y-3Y)',
    'macro.kr_credit_spread': 'Credit Spread (AA- 3Y)',
    'macro.kr_unemp_yoy': 'Unemployment YoY',
    'macro.kr_unemp_rate': 'Unemployment Rate',
    'macro.kr_permit_yoy': 'Building Permits YoY',
    'macro.kr_retail_yoy': 'Retail Sales YoY',
    'macro.kr_capex_yoy': 'CapEx YoY',
    'macro.kr_income_yoy': 'Household Income YoY',
    'macro.kr_cpi_yoy': 'CPI YoY',
    'macro.kr_gdp_yoy': 'Real GDP YoY',
    'macro.kr_m2_yoy': 'M2 YoY',
    'macro.kr_indpro_chg3m': 'IndPro 3M Change',
    'macro.kr_capex_yoy_chg3m': 'CapEx 3M Change',

    // ── KR Macro Descriptions ──
    'macroDesc.kr_indpro_yoy': 'Industrial production index YoY (manufacturing momentum)',
    'macroDesc.kr_yield_spread': '10Y-3Y KTB spread (inversion = recession signal)',
    'macroDesc.kr_credit_spread': 'AA- 3Y corp - 3Y KTB (credit risk)',
    'macroDesc.kr_unemp_yoy': 'Unemployment rate YoY change (positive = job market deterioration)',
    'macroDesc.kr_unemp_rate': 'Unemployment rate (seasonally adjusted, KR avg ~3%)',
    'macroDesc.kr_permit_yoy': 'Building permits area YoY (housing leading indicator)',
    'macroDesc.kr_retail_yoy': 'Retail sales index YoY (consumption indicator)',
    'macroDesc.kr_capex_yoy': 'Capital investment index YoY (business investment)',
    'macroDesc.kr_income_yoy': 'Household income YoY (quarterly, ffill)',
    'macroDesc.kr_cpi_yoy': 'Consumer price index YoY (BOK target 2%)',
    'macroDesc.kr_gdp_yoy': 'Real GDP YoY (quarterly, ffill)',
    'macroDesc.kr_m2_yoy': 'M2 broad money YoY (liquidity indicator)',
    'macroDesc.kr_indpro_chg3m': 'IndPro YoY 3-month change (momentum)',
    'macroDesc.kr_capex_yoy_chg3m': 'CapEx YoY 3-month change',
    ...
    // ── KR Crash/Surge 24 feature labels ──
    'feat.KOSPI_LOGRET_1D': 'KOSPI 1D Return',
    'feat.KOSPI_LOGRET_5D': 'KOSPI 5D Return',
    'feat.KOSPI_LOGRET_10D': 'KOSPI 10D Return',
    'feat.KOSPI_LOGRET_20D': 'KOSPI 20D Return',
    'feat.KOSPI_DRAWDOWN_60D': 'KOSPI 60D Drawdown',
    'feat.KOSPI_MA_GAP_50': 'KOSPI 50D MA Gap',
    'feat.KOSPI_MA_GAP_200': 'KOSPI 200D MA Gap',
    'feat.VKOSPI_LEVEL': 'VKOSPI',
    'feat.VKOSPI_CHANGE_1D': 'VKOSPI 1D Change',
    'feat.VKOSPI_PCTL_252D': 'VKOSPI Percentile',
    'feat.KR_CORP_AA3Y_SPREAD': 'KR Corp AA-3Y Spread',
    'feat.KR_CORP_SPREAD_CHG_5D': 'KR Spread 5D Change',
    'feat.KR_CORP_SPREAD_CHG_20D': 'KR Spread 20D Change',
    'feat.KR_DGS10_LEVEL': 'KR 10Y Treasury',
    'feat.KR_T10Y3M_SLOPE': 'KR Yield Curve Slope',
    'feat.FOREIGN_NET_BUY_1D': 'Foreign 1D Net Buy',
    'feat.FOREIGN_NET_BUY_5D': 'Foreign 5D Net Buy',
    'feat.USDKRW_RET_5D': 'USD/KRW 5D Return',
    'feat.KOSPI_DOLLAR_VOL_Z_20D': 'KOSPI Dollar Volume Z',
