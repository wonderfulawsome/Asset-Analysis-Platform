...
(function() {
  ...
  const MARKET_EVENTS_US = [
    ...
    { from: '2021-02-22', to: '2021-04-30', label: '美 국채금리 급등·재오픈 트레이드 (가치주 rotation)' },
    { from: '2021-05-01', to: '2021-06-15', label: '美 CPI 4~5%·인플레이션 우려 본격화' },
    ...
    { from: '2025-02-01', to: '2025-03-15', label: '美 對中·캐나다·멕시코 관세 부과' },
